...
<!-- -->
    ...
    ##  C:\Users\danie\AppData\Local\Temp\RtmpW6NHf3\downloaded_packages
...
The analyst then added “day\_of\_week” and “month\_yr” attributes by
identifying the weekday, month, and year of the trip start dates.
...
-   The historical data indicate that *Saturday* is the day with the
    *highest ridership*, and *Monday* is the day with the *lowest
    ridership*;
...
-   Focus marketing campaign around *“Streeter Dr & Grand Ave”* and
    *“Lake Shore Dr & Monroe St”* stations on weekends to better target
    annual membership products to the casual riders;
-   Focus marketing campaign around *“MLK Jr Dr & 29th St”* and *“State
    St & 33rd St”* stations to better target membership retention
    programs to the members; and
